...
const CELL_COUNT = 40;
const CHIP_CLASSES =
    'inline-flex cursor-pointer items-center whitespace-nowrap rounded-full border border-white/10 bg-white/[.04] px-4 py-[9px] text-[13px] text-[#aaa] transition duration-200 hover:bg-white/8 hover:text-white';
